...
if (finalScore >= 8) {
  ...
  advice =
    "Good performance overall. Improve confidence, communication, and provide more detailed explanations with practical examples.";
} else {
  advice =
    "Focus on strengthening technical concepts, communication skills, and confidence through regular practice and mock interviews.";
}
...
const adviceHeight = splitAdvice.length * 6 + 15;
...
autoTable(doc, {
 ...
 doc.save("AI_Interview_Report.pdf");
  ...
  return (
        ...
        <div className='md:mb-10 w-full flex items-start gap-4 '>
          ...
          <div>
            ...
            <p className='text-gray-500 mt-2'>
              Analyze your past interviews to identify strengths and areas for improvement.                        </p>
          </div>
        </div>
   ...
   text-white py-3 px-6 rounded-xl shadow-md transition-all 
