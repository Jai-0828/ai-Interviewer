...
import femaleVideo from "../assets/videos/femaleVideo.mp4"
    ...
    to-teal-100 flex items-center justify-center p-4 sm:p-6'>
      ...
      <div className='w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          ...
          {subtitle && (
            <div className='w-full max-w- bg-gray-50 border border-gray-200 rounded-xl shadow-sm'>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          {!isIntroPhase && (<div className='relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm'>
            ...
            <div className='text-base sm:text-lg font-semibold text-gray-800 leading-relaxed'>{currentQuestion?.question}
            </div>
          </div>)
          }
          <textarea
