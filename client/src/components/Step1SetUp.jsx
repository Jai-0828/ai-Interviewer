        ...
        <motion.div
          ...
          <div className='space-y-6'>
            <div className='relative'>
              <FaUserTie className='absolute top-4 text-gray-400' />
            ...
            <div className='relative'>
              <FaBriefcase className='absolute top-4 text-gray-400' />
              <input type='text' placeholder='Years of experience'
                className='w-full pl-12 pr-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
              ...
              <motion.div
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    {analyzing ? "Analyazing..." : "Analyze Resume"}
